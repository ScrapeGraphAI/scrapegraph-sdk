...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Credits.List(context.Background())
	if userAgent != fmt.Sprintf("ScrapegraphaiSDK/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	err := client.Credits.List(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	err := client.Credits.List(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		err := client.Credits.List(deadlineCtx)
		if err == nil {
