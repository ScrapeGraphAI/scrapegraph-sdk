"""
Example demonstrating how to use the HTMLfy API with the scrapegraph-py SDK.

This example shows how to:
1. Set up the client for HTMLfy
...
def main():
    ...
    print("HTMLfy API Example with scrapegraph-py SDK")
    print("=" * 60)
