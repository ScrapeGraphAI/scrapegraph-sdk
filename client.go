...
type Client struct {
	...
	Smartscraper   SmartscraperService
...
// DefaultClientOptions read from the environment (SCRAPEGRAPHAI_SDK_API_KEY,
// SCRAPEGRAPHAI_SDK_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("SCRAPEGRAPHAI_SDK_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("SCRAPEGRAPHAI_SDK_API_KEY"); ok {
...
// environment (SCRAPEGRAPHAI_SDK_API_KEY, SCRAPEGRAPHAI_SDK_BASE_URL). The option
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Smartscraper = NewSmartscraperService(opts...)
